 ...
 * @author ...
 */
export class LightmapScene_WebGPU {
    ...
    constructor() {
		...
		Laya.init(0, 0).then(() => {
			...
			Scene3D.load("sample-resource/res/threeDimen/scene/ParticleScene/Scene.ls", Handler.create(this, function (sprite: Scene3D): void {
