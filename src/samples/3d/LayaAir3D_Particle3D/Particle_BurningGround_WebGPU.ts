 ...
 * @author ...
 */
export class Particle_BurningGround_WebGPU {
    ...
    constructor() {
        ...
        Laya.init(0, 0).then(() => {
            ...
            Sprite3D.load("sample-resource/res/threeDimen/particle/ETF_Burning_Ground.lh", Handler.create(this, function (sprite: Sprite3D): void {
