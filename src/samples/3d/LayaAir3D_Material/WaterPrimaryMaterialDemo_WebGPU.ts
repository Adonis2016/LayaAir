...
export class WaterPrimaryMaterialDemo_WebGPU {
    ...
    constructor() {
		...
		Laya.init(0, 0).then(() => {
			...
			Scene3D.load("sample-resource/res/threeDimen/scene/LayaScene_water/Conventional/Default.ls", Handler.create(this, function (scene: Scene3D): void {
